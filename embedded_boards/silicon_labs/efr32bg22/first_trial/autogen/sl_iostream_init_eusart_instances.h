...
extern sl_iostream_t *sl_iostream_eusart_test_handle;
extern sl_iostream_uart_t *sl_iostream_uart_eusart_test_handle;
extern sl_iostream_instance_info_t sl_iostream_instance_eusart_test_info;
